    ...
    <TracingBeam className="px-6">
      ...
      >
        ...
        <section className="relative min-h-screen flex items-center justify-center px-6">
          ...
          <div
            className="absolute bottom-32 right-10 w-32 h-32 bg-secondary/30 rounded-full blur-xl animate-float"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-1/2 right-20 w-16 h-16 bg-accent/20 rounded-full blur-xl animate-float"
          ...
          <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-gradient-primary hover:scale-105 transition-transform duration-200 text-lg px-8 py-6 rounded-2xl"
                >
                  Start Chatting ✨
                </Button>
                <Button
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Discover the features that make our chat platform the best
                choice for modern communication
              </p>
            </div>
            ...
            <div className="bg-gradient-primary rounded-3xl p-12 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
                  Join millions of users who have already upgraded their chat
                  experience
                </p>
        ...
        <ContainerScroll
          titleComponent={<h1 className="text-4xl font-semibold text-white">Your Title Here</h1>}
        >
